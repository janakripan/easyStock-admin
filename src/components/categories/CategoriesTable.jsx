  ...
  return (
    <div className="min-h-screen  p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        {/* Table Container */}
        <div className="bg-blaack/5 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/5  shadow-black/40 overflow-hidden">
                    ...
                    .map((item, index) => (
                      ...
                      >
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="w-fit px-2 h-8 bg-gradient-to-r from-black/8 to-base-200 rounded-full backdrop-blur-lg tracking-wide flex items-center justify-center border border-white/5 text-sm font-bold shadow-lg">
                              {item.id}
                            </div>
                          </div>
                        </td>
            ...
            <div className="flex flex-col gap-6 md:flex-row items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className=" /70 bg-black/20 hover:scale-105 active:scale-100 active:bg-black/30 backdrop-blur-lg px-3 py-2 rounded-lg border-white/5 border shadow-lg shadow-black/15 transition-all duration-300"
                >
                  download excel
                </button>
              </div>
