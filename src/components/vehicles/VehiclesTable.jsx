    ...
    <div className="min-h-screen  p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-black/5 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/5  shadow-black/40 overflow-hidden">
                  ...
                  processedItems
                    ...
                    .map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <span className="text-lg font-semibold bg-clip-text ">
                             {item.driverName}
                            </span>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <div className="flex items-center justify-center space-x-3">
                            <button
                              ...
                              className="inline-flex items-center px-3 py-2 text-sm font-medium  bg-gradient-to-b from-primary/60 via-primary/30 to-primary/60 hover:bg-primary/60 rounded-lg focus:outline-none  transform hover:scale-105 transition-all duration-200 shadow-lg shadow-black/10"
                            >
                              <FiEdit/>
                              Edit
                            </button>
          ...
          {/* Footer */}
          <div className="bg-gradient-to-r from-primary/60 via-primary/30 to-primary/60 px-6 py-4 border-t border-gray-700">
            <div className="flex flex-col gap-6 md:flex-row items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className=" /70 bg-white/10 hover:scale-105 active:scale-100 active:bg-black/30 backdrop-blur-lg px-3 py-2 rounded-lg border-white/5 border shadow-lg shadow-black/15 transition"
                >
                  download excel
                </button>
              </div>
