  ...
  return (
    <>
      <div className="w-full h-screen  flex flex-col max-w-screen-xl mx-auto  relative ">
        <Header pageName={"Uom"} onAddClick={setAddOpen} />
      ...
      {/* add uom modal */}
      <div
        className={`absolute inset-0 bg-base-100/40 backdrop-blur-md z-50  flex flex-col items-center justify-center p-2 overflow-y-auto  ${
          addOpen ? "flex" : "hidden"
        }`}
      >
